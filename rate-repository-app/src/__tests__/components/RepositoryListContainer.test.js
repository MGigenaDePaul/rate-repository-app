...
describe('RepositoryList', () => {
  describe('RepositoryListContainer', () => {
    it('renders repository information correctly', () => {
      ...
      screen.debug(firstRepositoryItem);
      ...
      expect(firstRepositoryItem).toHaveTextContent(/2k/); 
      expect(firstRepositoryItem).toHaveTextContent(/22k/); 
      ...
      expect(secondRepositoryItem).toHaveTextContent(/2k/);
